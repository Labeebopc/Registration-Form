...
function Login() {
  ...
  return (
    <form action='/login' className='loginform' method='post' onSubmit={handleLogin}>
      ...
      <button id='loginbtn1' type="submit" className="btn btn-primary">Login</button>
      <Link to='/register' id='loginbtn2' type="submit" className="btn btn-primary">Register</Link>
    </form>
  )
}
